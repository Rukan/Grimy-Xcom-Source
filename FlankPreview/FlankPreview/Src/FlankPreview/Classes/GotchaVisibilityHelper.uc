...
simulated static function bool IsFlankedByLocation(TTile ttSource, XComGameState_Unit SourceUnitState, XComGameState_Unit TargetUnitState, GameRulesCache_VisibilityInfo VisibilityInfo) {
	...
	if ( TargetUnitState == none ) { return false; }
	if ( !TargetUnitState.GetMyTemplate().bCanTakeCover ) { return false; }
	if ( !SourceUnitState.CanFlank() ) { return false; }
	if ( SourceUnitState.IsMeleeOnly() ) { return false; }
