class GrimyLootPCS_UtilityItems extends X2Item config(GrimyLootPCS_ItemData);
...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Resources.AddItem(CreateCommonHackBonus());
	Resources.AddItem(CreateRareHackBonus());
	Resources.AddItem(CreateEpicHackBonus());
...
static function X2DataTemplate CreateAmpBooster()
{
	...
	Template.SetUIStatMarkup(class'XLocalizedData'.default.PsiOffenseBonusLabel, eStat_PsiOffense, class'GrimyLootPCS_Abilities'.default.GRIMY_AMPBOOSTER_BONUS, true);
...
static function X2DataTemplate CreateNeuroWhip()
{
	...
	Template.SetUIStatMarkup(class'XLocalizedData'.default.PsiOffenseBonusLabel, eStat_PsiOffense, class'GrimyLootPCS_Abilities'.default.GRIMY_NEUROWHIP_BONUS, true);
...
static function X2DataTemplate CreateCommonPSIConditioning()
{
	...
	`CREATE_X2TEMPLATE(class'X2EquipmentTemplate', Template, 'GrimyCommonPCSPsi');
...
static function X2DataTemplate CreateRarePSIConditioning()
{
	...
	`CREATE_X2TEMPLATE(class'X2EquipmentTemplate', Template, 'GrimyRarePCSPsi');
...
static function X2DataTemplate CreateEpicPSIConditioning()
{
	...
	`CREATE_X2TEMPLATE(class'X2EquipmentTemplate', Template, 'GrimyEpicPCSPsi');
...
static function X2DataTemplate CreateCommonHackBonus()
{
	local X2EquipmentTemplate Template;

	`CREATE_X2TEMPLATE(class'X2EquipmentTemplate', Template, 'GrimyCommonPCSHack');

	Template.LootStaticMesh = StaticMesh'UI_3D.Loot.AdventPCS';
	Template.strImage = "img:///GrimyLootPCSPackage.Inv_CombatSim_Hacking";
	Template.ItemCat = 'combatsim';
	Template.TradingPostValue = 20;
	Template.bAlwaysUnique = false;
	Template.Tier = 0;
...
static function X2DataTemplate CreateRareHackBonus()
{
	local X2EquipmentTemplate Template;

	`CREATE_X2TEMPLATE(class'X2EquipmentTemplate', Template, 'GrimyRarePCSHack');
...
static function X2DataTemplate CreateEpicHackBonus()
{
	local X2EquipmentTemplate Template;

	`CREATE_X2TEMPLATE(class'X2EquipmentTemplate', Template, 'GrimyEpicPCSHack');
