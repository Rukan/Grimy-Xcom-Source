...
simulated function UpdateData()
{
	...
	else if(CustomizeManager.HasPartsForPartType("LeftArm", `XCOMGAME.SharedBodyPartFilter.FilterByTorsoAndArmorMatch))
	{
		//If they have parts for left arm, we assume that right arm parts are available too.
		GetListItem(i++).UpdateDataValue(class'UIUtilities_Text'.static.GetColoredText(m_strLeftArm, eUIState_Normal),
										CustomizeManager.FormatCategoryDisplay(eUICustomizeCat_LeftArm, , FontSize), CustomizeLeftArm);

		GetListItem(i++).UpdateDataValue(class'UIUtilities_Text'.static.GetColoredText(m_strRightArm, eUIState_Normal),
										 CustomizeManager.FormatCategoryDisplay(eUICustomizeCat_RightArm, , FontSize), CustomizeRightArm);
				
		if(CustomizeManager.HasPartsForPartType("LeftArmDeco", `XCOMGAME.SharedBodyPartFilter.FilterByTorsoAndArmorMatch))
		{
			GetListItem(i++).UpdateDataValue(class'UIUtilities_Text'.static.GetColoredText(m_strLeftArmDeco, eUIState_Normal),
											 CustomizeManager.FormatCategoryDisplay(eUICustomizeCat_LeftArmDeco, , FontSize), CustomizeLeftArmDeco);

			GetListItem(i++).UpdateDataValue(class'UIUtilities_Text'.static.GetColoredText(m_strRightArmDeco, eUIState_Normal),
											 CustomizeManager.FormatCategoryDisplay(eUICustomizeCat_RightArmDeco, , FontSize), CustomizeRightArmDeco);
		}
	}
