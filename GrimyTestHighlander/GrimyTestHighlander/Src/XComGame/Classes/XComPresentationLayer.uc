...
//----------------------------------------------------
//grimy changes, converted from m_kgenericturncounter to m_kTurnCounter2
simulated function UITimerMessage( string sTitle, string sSubtitle, string sCounter, int iUIState, bool bShow )
{
	...
	if ( class'GrimyHighlanderConfig'.default.SHIFT_MISSION_TIMERS ) {
		kTurnCounter = GetSpecialMissionHUD().m_kTurnCounter2;
	}
	else {
