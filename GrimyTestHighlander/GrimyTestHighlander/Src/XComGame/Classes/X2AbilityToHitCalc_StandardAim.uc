...
protected function int GetHitChance(XComGameState_Ability kAbility, AvailableTarget kTarget, optional bool bDebugLog=false)
{
	...
	{				
		...
		if (bReactionFire)
		{
			if ( !class'X2AbilityToHitCalc'.default.ENABLE_OVERWATCH_TWEAK || UnitState.ControllingPlayerIsAI() || `TACTICALRULES.isAlienActivity() )
			{
...
function float GetReactionAdjust(XComGameState_Unit Shooter, XComGameState_Unit Target)
{
	...
	// Start of Grimy Additions
	if ( !class'X2AbilityToHitCalc'.default.ENABLE_OVERWATCH_TWEAK || Shooter.ControllingPlayerIsAI() ||`TACTICALRULES.isAlienActivity() )
	{
