...
{
	return !IsMeleeOnly() && StunnedActionPoints < 2;
}
...
function RankUpSoldier(XComGameState NewGameState, optional name SoldierClass, optional bool bRecoveredFromBadClassData, optional bool bRoulette = false)
{
	...
	if (m_SoldierRank == 0)
	{
		...
		if ( ( class'Grimy_Utility_TrainingRoulette'.default.RouletteAllSoldiersChance > `SYNC_RAND(100) || bRoulette ) && SoldierClass != 'PsiOperative' && SoldierClass != 'CentralOfficer' ) {
			class'Grimy_Utility_TrainingRoulette'.static.MakeRouletteSoldier(self, NewGameState);
