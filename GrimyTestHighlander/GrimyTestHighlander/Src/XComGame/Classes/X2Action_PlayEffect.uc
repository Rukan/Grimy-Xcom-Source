...
simulated state Executing
{
	...
	private function RequestLookAtCamera()
	{
		...
		LookAtCam.LookAtDuration = min(CenterCameraOnEffectDuration,class'GrimyHighlanderConfig'.default.LOOKAT_TIME);
...
Begin:
	...
	{
		while( WorldInfo.TimeSeconds < EffectSpawnTime + min(CenterCameraOnEffectDuration,class'GrimyHighlanderConfig'.default.LOOKAT_TIME) )
		{
			Sleep(0.0);
		}
