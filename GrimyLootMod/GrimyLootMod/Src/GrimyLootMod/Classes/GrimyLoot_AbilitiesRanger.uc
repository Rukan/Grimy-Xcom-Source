...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	// sword abilities
	Templates.AddItem(GrimyAbilityCharges(2,'GrimyChargeConcealOne', 'Stealth'));
	Templates.AddItem(GrimyAbilityCharges(3,'GrimyChargeConcealTwo', 'Stealth'));
	Templates.AddItem(GrimyAbilityCharges(4,'GrimyChargeConcealThree', 'Stealth'));

	Templates.AddItem(GrimyAbilityCharges(3,'GrimyChargeCombatProtocolOne', 'CombatProtocol'));
	Templates.AddItem(GrimyAbilityCharges(4,'GrimyChargeCombatProtocolTwo', 'CombatProtocol'));
	Templates.AddItem(GrimyAbilityCharges(5,'GrimyChargeCombatProtocolThree', 'CombatProtocol'));
	Templates.AddItem(GrimyAbilityCharges(2,'GrimyChargeMjolnirOne', 'CapacitorDischarge'));
	Templates.AddItem(GrimyAbilityCharges(3,'GrimyChargeMjolnirTwo', 'CapacitorDischarge'));
	Templates.AddItem(GrimyAbilityCharges(4,'GrimyChargeMjolnirThree', 'CapacitorDischarge'));
	Templates.AddItem(GrimyAbilityCharges(2,'GrimyChargeScanningOne', 'ScanningProtocol'));
	Templates.AddItem(GrimyAbilityCharges(3,'GrimyChargeScanningTwo', 'ScanningProtocol'));
	Templates.AddItem(GrimyAbilityCharges(4,'GrimyChargeScanningThree', 'ScanningProtocol'));
