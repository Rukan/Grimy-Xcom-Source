...
static function X2AbilityTemplate GrimyChargeBarrier(name TemplateName, int Bonus, int Duration, int ThisCooldown)
{
	...
	//Template.OverrideAbilities.additem('Inspire');
...
static function X2AbilityTemplate GrimyBonusDamageAbility(name TemplateName, int Bonus, name AbilityName, int BonusCharges)
{
	local X2AbilityTemplate							Template;
